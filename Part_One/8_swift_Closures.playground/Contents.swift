...
// 对闭包进行调用 将返回9
myClosures(3)
func mySort(array: inout [Any], sortClosure: (Any, Any)->Bool)->[Any] {
    // 进行冒泡排序算法
...
// 将学生放入数组
var stuArr: [Any] = [stu1, stu2, stu3, stu4]
// 进行排序
mySort(array: &stuArr) {
...
// 创建一个函数 通过闭包来传递遍历结果
func MyEnumDic(dic: [Int: String], closure: (_ key: Int, _ value: String)->Bool) {
    // 遍历字典
    for item in dic {
        // 执行闭包代码
